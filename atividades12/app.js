...
const h1UpperCase = document.querySelector('h1')

h1UpperCase.textContent = h1UpperCase.textContent.toUpperCase()
...
numbers.forEach(number => {
    ul.innerHTML += `<l1 class="number">${number}</l1>`
})
...
const stylesNumbers = document.querySelectorAll('.number')

stylesNumbers.forEach(styles => {
    if(styles.textContent % 2 === 0) {
        styles.style.color = 'lightblue'
    } else {
        styles.style.color = 'pink'
    }
})
