...
brazilianFoods.push('coxinha',null,'foods');
...
brazilianFoods[1] = 'pao de quiejo'
...
dogNames.pop()
console.log(dogNames[dogNames -1])
...
console.log(dogNames.toLowerCase())
...
const dessert = `${dogNames[0].slice(3)}${dogNames[1].slice(2)}${dogNames[2].slice(2)}`.replace('n', 'd')
console.log(dessert)
