...
//   }
  ...
  */
  ...
  const characters = string => string.length
  console.log(characters('ola'))
  ...
  */
  const charactersMin = string => string.toLowerCase()
  console.log(charactersMin("CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"))
  /*
    04
  w
  ...
  */
  ...
  console.log(characterIndex('3', '12345'))
  /*
    05
  ...
  */
  ...
  const verifyboolean = (item, array) => array.includes(item)
  
  console.log(verifyboolean('3', [7, 3, 1]))
  /*
    06
  ...
  */
  ...
  const arrayConcate = (firstArray, secondArray) => firstArray.concat(secondArray)
  console.log(arrayConcate([1,2,3],[4,5,6]))
  ...
  */
      ...
      const RemoveNewArray = (array) => {
        array.pop()
        return array
      }

      console.log(RemoveNewArray([1,2,3]))
  ...
  */
  const inCallBack = (value, callback) => {
    return callback(value)
  }
  const triple = (number) => number * 3
  console.log(inCallBack(33, triple))
  ...
  */
  ...
  const showMyarray = (item, index, array) => {
    const itemPosition = index + 1
    const myArray = array.join(', ')
    console.log(`O ${itemPosition}º item do array [${myArray}] é ${item}.`)
  }

  numbers.forEach(showMyarray)
...
//   }
  ...
  */
      ...
      const getLikesMenssage = (names = []) => {
        const moreLikeNames = names.length - 2
        ...
        switch(names.length){
            ...
            default:
                return `${firstName}, ${secondName} e mais ${moreLikeNames} curtiram isso `
        }
      }

      console.log(getLikesMenssage(['Luan', 'Fabi', 'Diogo', 'Luana,', 'Pretinha']))