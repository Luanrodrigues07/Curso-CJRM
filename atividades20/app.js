...
peopleCopy.sort((a, b) => b.score - a.score)
...
const animaisTr = animals.filter(animals => animals.length === 3)


console.log(animaisTr)
/*
  04
...
*/
const animaisCopy = animals.map(animal => animal.length)
console.log(animaisCopy)
/*
  05
...
const friendsNearMe = friendsCopy.map(friend => friend.name)
...
.reduce((number, number1) => number + number1)
