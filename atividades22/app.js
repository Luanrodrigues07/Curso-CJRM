...
const months = [
  ...
  */
  ...
  /*
    ...
    - Exiba o objeto no console.
  */
  const past = new Date('May 5 2022 15:38:00')
  ...
  */
  ...
  /*
    ...
    - Exiba o objeto no console.
  */
  const future = new Date('May 5 2024 17:47:00')
  console.log({future})
  /*
    07
  ...
  */
  const futureToPast = future.getTime() - past.getTime()
  const days = Math.round(futureToPast / 86400000)
