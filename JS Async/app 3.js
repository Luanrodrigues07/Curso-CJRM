...
const getNewArray = num => num < 5
const lesserThanFive = numbers.filter(getNewArray)
...
const arguments = (param1, param2, param3) => {
    const paramUndefined = [param1, param2, param3].includes(undefined)
...
booksBox.addBooks = books => {
    const quantidade = booksBox.booksIn === booksBox.spaces
    const spacesBook = booksBox.booksIn + books > booksBox.spaces
    if (quantidade) {
